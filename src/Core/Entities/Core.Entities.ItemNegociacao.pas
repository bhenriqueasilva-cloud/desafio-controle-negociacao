unit Core.Entities.ItemNegociacao;
...
procedure TItemNegociacao.SetQuantidade(const AValue: Double);
begin
  if AValue <= 0 then
...
procedure TItemNegociacao.SetPrecoUnitario(const AValue: Currency);
begin
  if AValue <= 0 then
...
procedure TItemNegociacao.SetValorTotal(const AValue: Currency);
begin
  if AValue < 0 then
...
procedure TItemNegociacao.Validar;
begin
...
procedure TItemNegociacao.CalcularValorTotal;
begin
